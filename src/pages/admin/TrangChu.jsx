...
import "./TrangChu.css";
import DataGridView from "../../components/DataGridView"; // Assuming this is the correct path for DataGridView
import classService from "../../services/classService"; // Assuming this is the correct import for classService
    ...
    <div className="container admin-home">
      ...
      <section className="class-list-section">
        {loading ? (
          ...
          <DataGridView listData={classData} canCheck={false} canEdit={false} />
        )}
      </section>
    </div>
  );
