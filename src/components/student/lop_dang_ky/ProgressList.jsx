...
const ProgressList = ({
  ...
  const hasSelectedClasses = numberOfClasses > 0;
  ...
  return (
    <div className="mt-[72px] bg-white border border-gray-300 rounded shadow-md p-4 w-60 fixed top-0 right-0 h-screen flex flex-col">
      ...
      <button
        onClick={onRegister}
        className={`bg-[#E43D3D] text-white py-2 px-4 rounded mt-24 shadow-xl ${
          !hasSelectedClasses ? "opacity-50 cursor-not-allowed" : ""
        }`}
